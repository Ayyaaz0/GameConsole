...
static const uint16_t palette_chroma[16] = {
  ...
  RGB565_CHROMA_GREY_PALE, RGB565_CHROMA_WHITE, RGB565_CHROMA_BLUE_DARK, RGB565_CHROMA_BLUE,
  RGB565_CHROMA_RED_DARK, RGB565_CHROMA_RED, RGB565_CHROMA_ORANGE_DARK, RGB565_CHROMA_ORANGE,
  RGB565_CHROMA_BROWN, RGB565_CHROMA_YELLOW, RGB565_CHROMA_GREEN_DARK, RGB565_CHROMA_GREEN,
};
